...
public class Game {
     ...
     * If game hasn't ended the re`turn` string has to be "None",
    ...
    public String checkGameWinner(char [][]grid){
        ...
        if(horizon(grid)=='X'||vertical(grid)=='X'||diagonal(grid)=='X'){
            result = "X wins";
        }
        else if(horizon(grid)=='O'||vertical(grid)=='O'||diagonal(grid)=='O'){
            result = "O wins";
        }
        else if(tie(grid)){
            result = "Tie";
    ...
    public char vertical(char [][]grid){
    ...
    public char diagonal(char [][]grid){
